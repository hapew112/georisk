...
| **KIS API 연동** | kis_trader.py, 토큰/잔고/주문 완료, 영업일 자동 주문 대기 | ✅ **완료** |
...
| 3 | 주간 리뷰 자동화 (paper_log → 성과 분석 → Telegram) | ⬜ 예정 (첫 점검: 2026-05-02) |
| 4 | v7 Kalman CRISIS overlay 추가 (v2 위에 얹기) | ⬜ 검토 |
| 5 | ARCH/GARCH 변동성 레짐 감지 | ⬜ 예정 |
| 6 | HMM 레짐 감지 | ⬜ 예정 |
